...
Follow the standard workflow: fetch the issue, check policy, search for existing rules, write a candidate rule, lint it, score its risk, and resolve placement.
