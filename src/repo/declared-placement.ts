 ...
 * nothing to say about a network candidate. Naming the candidate's own file is what makes the
 * declaration apply — the resolver already answered with it — and that is also what exempts the
 * candidate from the duplicate-class refusal, because the declaration prescribes its own edit.
 *
