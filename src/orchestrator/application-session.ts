 ...
 *
 * A detail names one step and what happened to it; 500 characters keeps that diagnostic-sized
 * without letting a page dump ride a terminal payload into the run record.
 */
export const APPLICATION_FAILURE_DETAIL_MAX = 500;
